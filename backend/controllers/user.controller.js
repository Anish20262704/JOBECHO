...
//         const cloudResponse = await cloudinary.uploader.upload(fileUri.content, {
//             resource_type: "raw",
//             use_filename: true,           // use your file name
//             unique_filename: false,       // don't add random suffix
//             public_id: baseName,           // keep original name
//             overwrite: true
//         });
...
export const updateProfile = async (req, res) => {
    try {
        ...
        const extName = path.extname(file.originalname); // e.g., '.pdf'
        const baseName = path.basename(file.originalname, extName); // e.g., 'resume'
        ...
        if (cloudResponse) {
            ...
            user.profile.resumeOriginalName = file.originalname; // store original filename
        }
